 ...
 *
 * Pipeline does not enforce an admin guard here: the gateway already
 * validated scope (`enforceRestScope` in the gateway auth middleware), and
 * pipeline accepts `apikey | oauth | session`.
 */
