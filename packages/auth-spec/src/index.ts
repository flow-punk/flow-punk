  ...
  tags: [
    {
      name: "API Keys",
      description:
        "Personal API key (`fpk_*`) lifecycle. Session-authenticated admin endpoints.",
    },
  ],
  components: {
    schemas: {
      ApiKey: {
        ...
        properties: {
          ...
          tenantId: {
            type: "string",
            description: "Synthesized from the gateway-stamped tenant scope.",
          },
          label: { type: "string" },
          prefix: {
            type: "string",
            description: "First 8 chars of the raw token (e.g., fpk_abcd).",
          },
          scopes: {
            type: "array",
      ...
      ApiKeyCreate: {
        ...
        properties: {
          ...
          rotatedFrom: {
            type: ["string", "null"],
            description:
              "ID of a revoked predecessor key, for rotation accounting.",
          },
        },
      },
      ApiKeyCreated: {
          ...
          { $ref: "#/components/schemas/ApiKey" },
          {
            ...
            properties: {
              token: {
                type: "string",
                description:
                  "Raw `fpk_<scope>.<random>` token. Returned only at creation; not retrievable later.",
              },
            },
          },
        ],
    ...
    "/api/v1/auth/keys": {
      get: {
        ...
        responses: {
          ...
          "403": {
            description: "Session credential required",
            content: { "application/json": { schema: ERROR_REF } },
          },
        },
      },
      post: {
        ...
        description:
          "Returns the raw token only on creation. Store it immediately — it cannot be retrieved later.",
        tags: ["API Keys"],
        requestBody: {
          required: true,
          content: {
