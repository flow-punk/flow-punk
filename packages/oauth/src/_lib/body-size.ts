/**
 * Body-size guards — vendored from `@flowpunk/gateway/body-size` to avoid
 * a circular dep with the gateway. Behaviorally identical; pure helpers
 * with no edition-specific behavior.
 */
