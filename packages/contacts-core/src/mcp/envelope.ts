...
export interface MutationOptions {
  /**
   * When true, the response carries the gateway invalidation header so the
   * gateway purges the tenant tools cache. Sent on any mutation that may
   * have flipped a tool-availability bit.
   */
