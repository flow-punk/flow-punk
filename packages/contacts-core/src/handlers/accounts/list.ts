...
export async function handleListAccounts(
  ...
  // read-capable credential could otherwise dump soft-deleted PII. The repo
  // accepts the option for future internal callers behind an admin gate;
  // the HTTP surface forces `false`.
