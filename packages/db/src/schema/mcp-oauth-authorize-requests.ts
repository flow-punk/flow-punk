...
export const mcpOauthAuthorizeRequests = sqliteTable(
  ...
  (t) => ({
    clientIdx: index('idx_mcp_oauth_authorize_requests_client_id').on(t.clientId),
  }),
);

export type McpOauthAuthorizeRequest = typeof mcpOauthAuthorizeRequests.$inferSelect;
export type NewMcpOauthAuthorizeRequest = typeof mcpOauthAuthorizeRequests.$inferInsert;
